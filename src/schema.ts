...
export const CropPlanSchema = Type.Object(
  {
    ...
    targetYieldValue: Type.Optional(Type.Number({ minimum: 0 })),
    targetYieldUnit: Type.Optional(Type.String()),
...
export const ObservationSchema = Type.Object(
  {
    ...
    source: Type.Optional(enumSchema(OBSERVATION_SOURCES, "Observation source.")),
    qualityFlag: Type.Optional(enumSchema(QUALITY_FLAGS, "Observation data-quality flag.")),
...
export const OperationSchema = Type.Object(
  {
    ...
    lotId: Type.Optional(Type.String({ minLength: 1 })),
    compliance: Type.Optional(
      Type.Object(
        {
          productName: Type.Optional(Type.String()),
          labelTargetCrop: Type.Optional(Type.String()),
          phiDays: Type.Optional(Type.Number({ minimum: 0 })),
          reiHours: Type.Optional(Type.Number({ minimum: 0 })),
...
export const RecommendationSchema = Type.Object(
  {
    ...
    rationale: Type.Array(Type.String({ minLength: 1 })),
